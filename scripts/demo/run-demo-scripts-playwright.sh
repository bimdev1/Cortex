...
# Modify the screenshot script to use the system's Chromium
RUN sed -i 's/chromium.launch/chromium.launch({ executablePath: "chromium-browser" }/g' scripts/demo/generate-screenshots.js
