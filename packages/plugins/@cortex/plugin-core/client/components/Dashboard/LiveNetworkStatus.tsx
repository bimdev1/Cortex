  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Live Network Status</h3>
        ...
        <div className="text-center py-8">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M34 40h10v-4a6 6 0 00-10.712-3.714M34 40H14m20 0v-4a9.971 9.971 0 00-.712-3.714M14 40H4v-4a6 6 0 0110.713-3.714M14 40v-4c0-1.313.253-2.566.713-3.714m0 0A9.971 9.971 0 0121 28c4.418 0 7.859 2.437 9.287 5.286"
            />
          </svg>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">No networks available</p>
        </div>
      ) : (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  {network.latency && (
                    <p className="text-xs text-gray-500 dark:text-gray-400">{network.latency}ms</p>
                  )}
      ...
      <div className="mt-4 text-xs text-gray-500 dark:text-gray-400 text-center">
        Last updated:{' '}
        {networks.length > 0 ? new Date(networks[0].lastChecked).toLocaleTimeString() : 'Never'}
      </div>
    </div>
  );
};
